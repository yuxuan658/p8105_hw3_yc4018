...
-   Since accelerometer data allows the inspection activity over the
    ...
    counts are small on the early morning; around the 250 minute of the
    day, the activity counts start increasing to around 2400 and stay
    for the rest of the day; on the evening, activity count has a
    rapidly growth which is starting from the 1200 minute of the day,
    then becomes decreasing at around 1300 minute of the day. Saturday
    has the high activity count on the early morning. During the week,
    the activity count has the highest value at the evening of the most
    of the days.
